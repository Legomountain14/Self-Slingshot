...
execute if entity @e[name="Legomountain14",nbt={SelectedItem:{id:"minecraft:bow",tag:{display:{Name:'{"text":"A","color":"blue","bold":true,"italic":true,"obfuscated":true,"extra":[{"text":"Self Slingshot","color":"red","bold":true,"italic":false,"obfuscated":false},{"text":"A","color":"blue","bold":true,"italic":true,"obfuscated":true}]}'}}}}] run execute as Legomountain14 run kill @e[type=minecraft:arrow,nbt={Owner: [I; 1312627576, 1134316269, -2067465437, 838602860],inGround:1b}]



execute if entity @e[name="Legomountain14",nbt={SelectedItem:{id:"minecraft:bow",tag:{display:{Name:'{"text":"A","color":"blue","bold":true,"italic":true,"obfuscated":true,"extra":[{"text":"Self Slingshot","color":"red","bold":true,"italic":false,"obfuscated":false},{"text":"A","color":"blue","bold":true,"italic":true,"obfuscated":true}]}'}}}}] run execute as Legomountain14 run tag @e[type=minecraft:arrow,sort=nearest,limit=1,nbt={Owner: [I; 1312627576, 1134316269, -2067465437, 838602860]}] add arrow1-Legomountain14
execute if entity @e[name="Legomountain14",nbt={SelectedItem:{id:"minecraft:bow",tag:{display:{Name:'{"text":"A","color":"blue","bold":true,"italic":true,"obfuscated":true,"extra":[{"text":"Self Slingshot","color":"red","bold":true,"italic":false,"obfuscated":false},{"text":"A","color":"blue","bold":true,"italic":true,"obfuscated":true}]}'}}}}] run execute as Legomountain14 run ride Legomountain14 mount @e[type=minecraft:arrow,sort=nearest,limit=1,tag=arrow1-Legomountain14,nbt={Owner: [I; 1312627576, 1134316269, -2067465437, 838602860]}]
execute if entity @e[name="Legomountain14",nbt={SelectedItem:{id:"minecraft:bow",tag:{display:{Name:'{"text":"A","color":"blue","bold":true,"italic":true,"obfuscated":true,"extra":[{"text":"Self Slingshot","color":"red","bold":true,"italic":false,"obfuscated":false},{"text":"A","color":"blue","bold":true,"italic":true,"obfuscated":true}]}'}}}}] run execute as Legomountain14 run tag @e[type=minecraft:arrow,sort=nearest,limit=1,tag=!arrow1-Legomountain14] add arrow2-Legomountain14
